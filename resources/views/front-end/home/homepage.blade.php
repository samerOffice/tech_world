...
@include('front-end.slider.slider')
    ...
    <div class="container-xxl py-5" id="about">
        <div class="container" style="margin-top: 50px;">           
            ...
            <div class="section-title text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">         
                <h1 class="display-6" style="font-family: Michroma; color: #22beda;">About Us</h1>
            </div>
            ...
            <div class="row g-5" >
                ...
                <div  class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-sm-8" >
                            <h5 style="font-family: Michroma; color: #464655;">Vision</h5>
                            <p class="mb-0" style="text-align: justify;
                                text-justify: inter-word; font-family: Michroma; color: #464655;">Easy access to technology and enrich yourself exponentially.</p>
                        </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-sm-8">
                            <h5 style="font-family: Michroma; color: #464655;">Mission</h5>
                            <p class="mb-0" style="text-align: justify;
                                text-justify: inter-word; font-family: Michroma; color: #464655;">Emerging the business with sophistication and keeping pace with cutting edge technology. Our mission to extend our business worldwide .To reach each corner of the world.</p>
                        </div>
                        <div class="col-sm-4">
                   ...
                   <div class="border-top mb-4"></div>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-sm-8" >
                            <h5 style="font-family: Michroma; color: #464655;">Values</h5>
                            <p class="mb-0" style="text-align: justify;
                                text-justify: inter-word; font-family: Michroma; color: #464655;">Enjoy every page of life and celebrate each small success to hold the abstract. Our associations and group bonds generate business value, lessen application risk and speed up the process of visibility in the market. </p>
                        </div>
                    ...
                    <div class="row g-3">
                        <div class="col-sm-8">
                            <h5 style="font-family: Michroma; color: #464655;">Corporate Governance</h5>
                            <p class="mb-0" style="text-align: justify;
                                text-justify: inter-word; font-family: Michroma; color: #464655;">With whom we function such as our clients, shareholders, vendors- associates, the communal, and the government everyone is our stakeholders. So, this is our responsibility to ensure righteousness.</p>
                        </div>
                        <div class="col-sm-4">
  ...
  <!-- Service Start -->
    <div class="container-xxl py-5" id="service">
        <div class="container" style="margin-top: 50px;">
             <div class="section-title text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">         
                <h1 class="display-6" style="font-family: Michroma; color: #22beda;">Our Services</h1>
            </div>
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative text-center">
                        ...
                        <div class="p-4">                           
                            <h5 class="mb-3" style="font-family: Michroma; color: #464655;">WEBSITE DESIGN & DEVELOPMENT</h5>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative text-center">
                        ...
                        <div class="p-4">                           
                            <h5 class="mb-3" style="font-family: Michroma; color: #464655;">CUSTOM SOFTWARE DEVELOPMENT</h5>
                        </div>
                        <div class="service-overlay">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative text-center">
                        ...
                        <div class="p-4">                           
                            <h5 class="mb-3" style="font-family: Michroma; color: #464655;">GRAPHICS DESIGN</h5>
                        </div>
                        <div class="service-overlay">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative text-center">
                        ...
                        <div class="p-4">                           
                            <h5 class="mb-3" style="font-family: Michroma; color: #464655;">DIGITAL MARKETING</h5>
                        </div>
                        <div class="service-overlay">
                 ...
                 <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative text-center">
                        ...
                        <div class="p-4">                           
                            <h5 class="mb-3" style="font-family: Michroma; color: #464655;">SEO SERVICES</h5>
                        </div>
                        <div class="service-overlay">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item position-relative text-center">
                        ...
                        <div class="p-4">                           
                            <h5 class="mb-3" style="font-family: Michroma; color: #464655;">BUSINESS CONTENT CREATION</h5>
                        </div>
                        <div class="service-overlay">
    ...
    <section id="parallax">
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div class="col-md-8">
            <h3 class="parallax-title" style="font-family: Michroma;">Are you ready to work together for your next project?</h3>
            <p class="parallax-text" style="font-family: Michroma">Discuss us for your project</p>
          </div>
          <div class="col-md-4 parallax-btn-container">
            <a class="parallax-btn" href="#contact" style="font-family: Michroma">Contact Us</a>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="container">
            <div class="row g-0">
                <div class="col-lg-6 py-5 wow fadeIn" data-wow-delay="0.1s">
                    <div class="py-5">
                        <h1 class="display-6 mb-4" style="font-family: Michroma; color: #464655;">Why choose us?</h1>
                        <h5 class="fw-normal lh-base fst-italic mb-5" style="font-family: Michroma; color: #464655;">Through our working knowledge we know our solutions, SEO and social media marketing can reach the message whatever it wants to go</h5>
                        <div class="row g-4 mb-5">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-dark" style="font-family: Michroma; color: #464655;">We listen our clients and on that base we provide our customize solutions</span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-dark" style="font-family: Michroma; color: #464655;">We are punctual, authentic and sincere about our services</span>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-dark" style="font-family: Michroma; color: #464655;">For devising new ideas, service, design we are the top of the time</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-dark" style="font-family: Michroma; color: #464655;">We are young, energetic, promising working team</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-dark" style="font-family: Michroma; color: #464655;">We emphasize results and we value your words</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="text-dark" style="font-family: Michroma; color: #464655;">We deliver our service timely</span>
                                </div>
                            </div>
                        </div>
                    </div>
